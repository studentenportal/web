        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "start_date",
                    models.DateField(
                        help_text="Format: dd.mm.YYYY", verbose_name="Startdatum"
                    ),
                ),
                (
                    "start_time",
                ...
                (
                    "location",
                    models.CharField(
                        help_text='Veranstaltungsort, zB "Geb\xe4ude 3" oder "B\xe4ren Rapperswil"',
                        max_length=80,
                        null=True,
                        verbose_name="Ort",
                        blank=True,
                ...
                (
                    ...
                    models.ImageField(
                        ...
                        upload_to=apps.events.models.picture_file_name,
                        null=True,
                        verbose_name="Bild/Flyer",
                        blank=True,
                    ),
                ),
            ],
