...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'DocumentDownload', fields ['ip']
        db.create_index('front_documentdownload', ['ip'])


    def backwards(self, orm):
        # Removing index on 'DocumentDownload', fields ['ip']
        db.delete_index('front_documentdownload', ['ip'])
