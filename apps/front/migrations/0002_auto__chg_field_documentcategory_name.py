...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('front_documentcategory', 'name', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=32))

        # Adding index on 'DocumentCategory', fields ['name']
        db.create_index('front_documentcategory', ['name'])


    def backwards(self, orm):
        
        # Removing index on 'DocumentCategory', fields ['name']
        db.delete_index('front_documentcategory', ['name'])

        # Changing field 'DocumentCategory.name'
        db.alter_column('front_documentcategory', 'name', self.gf('django.db.models.fields.CharField')(max_length=32, unique=True))
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 26, 13, 4, 43, 501826)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 26, 13, 4, 43, 501694)'}),
