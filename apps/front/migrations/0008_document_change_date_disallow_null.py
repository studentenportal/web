...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Document.change_date'
        db.alter_column('front_document', 'change_date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=None))


    def backwards(self, orm):
        
        # Changing field 'Document.change_date'
        db.alter_column('front_document', 'change_date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True))
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 4, 23, 45, 37, 359098)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 4, 23, 45, 37, 358851)'}),
