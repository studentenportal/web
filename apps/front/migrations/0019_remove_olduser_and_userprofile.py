...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.delete_table(u'front_userprofile')
        db.delete_table(u'auth_user')


    def backwards(self, orm):
        # Adding model 'UserProfile'
        db.create_table(u'front_userprofile', (
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['front.User'], unique=True)),
        ...
        db.send_create_signal(u'front', ['UserProfile'])
