...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('front_documentcategory', 'name', self.gf('apps.front.fields.CaseInsensitiveSlugField')(unique=True, max_length=32))


    def backwards(self, orm):
        
        # Changing field 'DocumentCategory.name'
        db.alter_column('front_documentcategory', 'name', self.gf('django.db.models.fields.SlugField')(max_length=32, unique=True))
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 26, 13, 45, 2, 925705)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 26, 13, 45, 2, 925593)'}),
