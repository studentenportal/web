...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('front_documentdownload', (
        ...
        db.send_create_signal('front', ['DocumentDownload'])


        # Changing field 'Event.author'
        db.alter_column('front_event', 'author_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['auth.User']))

        # Changing field 'Quote.author'
        db.alter_column('front_quote', 'author_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['auth.User']))
        # Deleting field 'Document.downloadcount'
        db.delete_column('front_document', 'downloadcount')


        # Changing field 'Document.category'
        db.alter_column('front_document', 'category_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.PROTECT, to=orm['front.DocumentCategory']))

        # Changing field 'Document.uploader'
        db.alter_column('front_document', 'uploader_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['auth.User']))

    def backwards(self, orm):
        # Deleting model 'DocumentDownload'
        db.delete_table('front_documentdownload')


        # Changing field 'Event.author'
        db.alter_column('front_event', 'author_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'Quote.author'
        db.alter_column('front_quote', 'author_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))
        # Adding field 'Document.downloadcount'
        db.add_column('front_document', 'downloadcount',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


        # Changing field 'Document.category'
        db.alter_column('front_document', 'category_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['front.DocumentCategory']))

        # Changing field 'Document.uploader'
        db.alter_column('front_document', 'uploader_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))
