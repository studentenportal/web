...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('front_event', 'picture',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Document.change_date'
        db.alter_column('front_document', 'change_date', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):
        # Deleting field 'Event.picture'
        db.delete_column('front_event', 'picture')


        # Changing field 'Document.change_date'
        db.alter_column('front_document', 'change_date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))
