...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('front_quotevote', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='QuoteVote', to=orm['auth.User'])),
            ('quote', self.gf('django.db.models.fields.related.ForeignKey')(related_name='QuoteVote', to=orm['front.Quote'])),
            ('vote', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('front', ['QuoteVote'])

        # Adding unique constraint on 'QuoteVote', fields ['user', 'quote']
        db.create_unique('front_quotevote', ['user_id', 'quote_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'QuoteVote', fields ['user', 'quote']
        db.delete_unique('front_quotevote', ['user_id', 'quote_id'])

        # Deleting model 'QuoteVote'
        db.delete_table('front_quotevote')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 20, 9, 47, 36, 297562)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 20, 9, 47, 36, 297439)'}),
