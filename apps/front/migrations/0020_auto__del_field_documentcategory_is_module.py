...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'DocumentCategory.is_module'
        db.delete_column(u'front_documentcategory', 'is_module')


    def backwards(self, orm):
        # Adding field 'DocumentCategory.is_module'
        db.add_column(u'front_documentcategory', 'is_module',
