...
urlpatterns = [
    ...
    url(r'^(?P<category>[^\/]+)/(?P<pk>-?\d+)/$', views.DocumentDownload.as_view(), name='document_download'),
    url(r'^(?P<category>[^\/]+)/thumbnail/(?P<pk>-?\d+)/$', views.DocumentThumbnail.as_view(), name='document_thumbnail'),
    url(r'^(?P<category>[^\/]+)/add/$', views.DocumentAdd.as_view(), name='document_add'),
