...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(m2m_table_name, (
            ...
            ('documentcategory', models.ForeignKey(orm[u'documents.documentcategory'], null=False)),
            ('course', models.ForeignKey(orm[u'lecturers.course'], null=False))
        ))
        db.create_unique(m2m_table_name, ['documentcategory_id', 'course_id'])

        # Adding M2M table for field lecturers on 'DocumentCategory'
        m2m_table_name = db.shorten_name(u'documents_documentcategory_lecturers')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('documentcategory', models.ForeignKey(orm[u'documents.documentcategory'], null=False)),
            ('lecturer', models.ForeignKey(orm[u'lecturers.lecturer'], null=False))
        ))
        db.create_unique(m2m_table_name, ['documentcategory_id', 'lecturer_id'])


    def backwards(self, orm):
        # Removing M2M table for field courses on 'DocumentCategory'
        db.delete_table(db.shorten_name(u'documents_documentcategory_courses'))

        # Removing M2M table for field lecturers on 'DocumentCategory'
        db.delete_table(db.shorten_name(u'documents_documentcategory_lecturers'))
