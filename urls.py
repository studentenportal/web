...
urlpatterns = patterns('apps.front.views',
    ...
    url(r'^dozenten/(?P<letter>[a-z])/$', views.LecturerList.as_view(), name='lecturer_list_letter'),
    ...
    url(r'^zusammenfassungen/(?P<category>[^\/]+)/(?P<pk>\d+)/$', views.DocumentDownload.as_view(), name='document_download'),
