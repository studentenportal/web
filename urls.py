...
urlpatterns = patterns('apps.front.views',
    ...
    url(r'^zusammenfassungen/edit/$', views.DocumentcategoryEdit.as_view(), name='documentcategory_edit'),
    url(r'^zusammenfassungen/delete/$', views.DocumentcategoryDelete.as_view(), name='documentcategory_delete'),
    ...
    #url(r'^zusammenfassungen/(?P<category>.*)/edit/$', views.DocumentEdit.as_view(), name='document_edit'),
    #url(r'^zusammenfassungen/(?P<category>.*)/delete/$', views.DocumentDelete.as_view(), name='document_delete'),
