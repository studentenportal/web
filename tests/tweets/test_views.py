...
class TweetListTest(TestCase):
    ...
    tweet1 = Tweet(id=431356619243266048,
                   text='"GeoDesign@HSR - why #Geodesign?" talk by Prof Carl Steinitz, Harvard Univ., 19. Mai 2014, 17h, Aula #HSR Hochschule für Technik Rapperswil',
    ...
    tweet3 = Tweet(id=391948408346255360,
                   text='Ladezeit der Modul-Liste (https://studentenportal.ch/dokumente/ ) von 3.8s auf 0.7s verringert :) #sql #optimierungen',
                   created_at=datetime.now(),
    ...
    def testTweetsFromApiAreDisplayed(self, tweepy_search, tweepy_user_timeline):
        #Arrange
        dir(self.tweet1)
