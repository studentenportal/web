...
class UserViewTest(AuthenticatedTest):
    ...
    def testUpdatePermissions(self):
        ...
        resp1 = self.client.patch(url1, json.dumps(data1), 'application/json')
        resp2 = self.client.patch(url2, json.dumps(data2), 'application/json')
    ...
    def testUsernameChange(self):
        ...
        resp = self.client.patch(url, json.dumps(data), 'application/json')
        self.assertEqual(resp.status_code, 200)
...
class QuoteViewTest(AuthenticatedTest):
    ...
    def testDetailData(self):
        ...
        resp = self.client.get(url)
        data = json.loads(resp.content)
        self.assertEqual(data['lecturer'], self.quote.lecturer.pk)
    ...
    def testAutoAuthorPUT(self):
        ...
        other_user = mommy.make(User)
        data = {
            'lecturer': self.quote.lecturer.pk,
